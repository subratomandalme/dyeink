-- v34 ANTI-ADBLOCK FIX
-- Renaming functions to avoid "stats" and "tracking" keywords which trigger blockers.

-- 1. DROP OLD FUNCTIONS (Clean up)
...
-- 2. CREATE FUNCTION: get_author_overview (Was: get_dashboard_stats)
...
-- 3. CREATE FUNCTION: count_post_visit (Was: increment_post_view)
...
-- 4. CREATE FUNCTION: count_post_action (Was: increment_shares)
