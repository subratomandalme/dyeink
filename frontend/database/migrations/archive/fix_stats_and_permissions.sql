...
-- 2. Increment Shares RPC (Security Definer to allow public access)
...
-- 3. Increment Views RPC (Security Definer)
...
-- 4. Grant Permissions to Public/Anon (CRITICAL)
...
-- 5. Update Dashboard Stats Function (to match latest requirements)
...
begin
  ...
  -- Subscribers (via blog_id -> site_settings link)
