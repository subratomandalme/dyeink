...
export default function Blog({ isCustomDomain = false }: BlogProps) {
    ...
    return (
        <div style={{ minHeight: '100vh', position: 'relative', overflowX: 'hidden' }}>
            ...
            {/* Content Wrapper */}
            <div className="blog-layout" style={{ position: 'relative', zIndex: 10, maxWidth: '1000px', margin: '0 auto', padding: '4rem 2rem', display: 'grid', gridTemplateColumns: 'minmax(200px, 250px) 1fr', gap: '4rem' }}>

                {/* Sidebar (Left) */}
                <aside className="blog-sidebar" style={{ position: 'sticky', top: '4rem', height: 'fit-content' }}>
                ...
                {/* Main Feed (Right) */}
                <main className="blog-content" ref={contentRef} style={{ paddingTop: '0.4rem' }}> {/* Adjusted alignment */}
                        ...
                        <div style={{ display: 'flex', gap: '1rem' }}>
                            ...
                            {twitterLink && (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    style={{ color: 'var(--text-secondary)', transition: 'color 0.2s', display: 'inline-flex' }}
                                >
                                    <Twitter size={22} />
                                </a>
                            )}
                    ...
                    {loading ? (
                        <div className="blog-loading" style={{ padding: '2rem 0', color: 'var(--text-muted)' }}>Loading...</div>
                    ) : posts.length === 0 ? (
            ...
            <style>{`
                ...
                @media (max-width: 1024px) {
                    ...
                    .blog-mobile-header {
                        ...
                        gap: 1.5rem;
                        margin-bottom: 4rem; /* Standardized Gap */
                        text-align: left;
                        border-bottom: none;
                        padding-bottom: 0;
                    }
                    ...
                    .post-list {
                        gap: 4rem !important; /* Standardized Gap */
                    }
                }
            `}</style>
        </div >
