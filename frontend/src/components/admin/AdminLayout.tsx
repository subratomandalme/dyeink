    ...
    return (
        <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: 'var(--bg-primary)' }}>
            ...
            <aside className="admin-sidebar" style={{
                ...
                <div className="sidebar-user-section" style={{ padding: '2rem 1.25rem 1rem 1.25rem' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.2rem' }}>
                        <span className="sidebar-greeting-text" style={{
                            fontSize: '1.5rem',
                        ...
                        <div className="sidebar-mobile-logo" style={{ display: 'none', width: '40px', height: '40px', margin: '0 auto' }}>
                            <img src="/Di.png" alt="Logo" style={{ width: '100%', height: '100%', objectFit: 'contain', filter: theme === 'dark' ? 'invert(1)' : 'none' }} />
                        </div>
                    </div>
                </div>

                {/* Create New Post Button */}
                <div style={{ padding: '0 1.25rem 1.5rem 1.25rem' }} className="sidebar-new-post-container">
                    <Link
                        to="/admin/posts/new"
                    ...
                    >
                        <span className="sidebar-new-post-icon">+</span>
                        <span className="sidebar-new-post-text">New Post</span>
                    </Link>
                </div>
                ...
                <nav style={{ flex: 1, padding: '0 1.25rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                    ...
                    >
                        <Home size={20} /> <span className="sidebar-text">Home</span>
                    </Link>
                    ...
                    >
                        <Globe size={20} /> <span className="sidebar-text">View</span>
                    </Link>
                    ...
                    >
                        <FileText size={20} /> <span className="sidebar-text">Posts</span>
                    </Link>

                    {/* Section: AUDIENCE */}
                    <div style={{ marginTop: '2rem' }} className="sidebar-section-wrapper">
                        <div className="sidebar-section-title" style={{
                            fontSize: '0.75rem',
                            fontWeight: 600,
                            color: 'var(--text-primary)',
                        ...
                        >
                            <BarChart2 size={20} /> <span className="sidebar-text">Stats</span>
                        </Link>
                    </div>
                ...
                <div style={{ padding: '1.25rem' }}>
                    <button
                        ...
                        className="btn-signout sidebar-item"
                        title="Sign Out"
                        style={{
                            display: 'flex',
                            alignItems: 'center',
                    ...
                    >
                        <LogOut size={18} /> <span className="sidebar-text">Sign Out</span>
                    </button>
                    <style>{`
                        .btn-signout:hover {
                        ...
                        /* RESPONSIVE SIDEBAR (< 1024px) */
                        @media (max-width: 1024px) {
                            .admin-sidebar {
                                width: 80px !important;
                                align-items: center !important; /* Force center all flex items */
                            }
                            .admin-main {
                            ...
                            /* Fix Create Button Centering */
                            .sidebar-new-post-container {
                                padding: 0 !important;
                                width: 100% !important;
                            ...
                            /* New Post Button turns into Circle Plus */
                            .sidebar-new-post-btn {
                                padding: 0 !important;
                                width: 48px;
                                height: 48px;
                                border-radius: 50% !important;
                                margin: 0 auto; /* Should work with flex parent */
                            }
                            .sidebar-new-post-icon {
                                font-size: 1.5rem;
                            }
                            
                            /* Show small logo at top instead of text */
                            .sidebar-mobile-logo {
                                display: block !important;
                            }
                            
                            /* Increase Icon Size for Touch Targets */
                            .sidebar-item svg {
                                width: 32px !important;
                                height: 32px !important;
                            }
                            .sidebar-new-post-icon {
                                font-size: 2rem !important; /* Larger + */
                            }
                        }
                    `}</style>
                </div>
