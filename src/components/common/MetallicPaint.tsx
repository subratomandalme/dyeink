            ...
            if (shapeCtx) {
                ...
                for (let y = 0; y < height; y++) {
                    for (let x = 0; x < width; x++) {
                        ...
                        const a = data[idx4 + 3];
                        // Treat any non-transparent pixel as part of the shape
                        shapeMask[y * width + x] = (a > 10); // Tolerance for semi-transparent edges
                    }
                }
                ...
                // const interiorMask = new Array(width * height).fill(false); // Unused
                ...
                reject(new Error("Could not get shape context"));
            }
        };
